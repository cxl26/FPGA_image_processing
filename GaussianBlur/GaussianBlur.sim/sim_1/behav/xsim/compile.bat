...
REM
REM Generated by Vivado on Sun Nov 13 23:05:58 +0000 2022
...
echo "xvlog --incr --relax -prj tb_gaussian_blur_vlog.prj"
call xvlog  --incr --relax -prj tb_gaussian_blur_vlog.prj -log xvlog.log
